...
of virtual assistants. As it is the base for natural language processing (NLP), 
...
One of the key drivers in Europe being the adaption of
voice-based-solutions in the industrial sector (Market Research Future, 2021). 
...
as this project is industry cooperation between the HEKUMA GmbH and the HSA. 
...
\headerbox{Outlook}{name=outlook,column=1,span=1,below=results}{
  ...
  \begin{center}
    \includegraphics[width=0.35\linewidth]{images/multi_lang.png}
  \end{center}
}
