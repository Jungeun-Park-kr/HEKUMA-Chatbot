...
Rasa makes it very easy to analyze intents, extract entities and connect them to answers or potential actions. This is archived through the NLU and Dialog Policies components.
