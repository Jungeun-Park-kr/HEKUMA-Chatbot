...
This project is a cooperation between the Hekuma GmbH and the University of Applied Science Augsburg.
...
With a very limited amount of training data in form the form of classified example sentences, 
...
Therefore, our Rasa actions server needs to understand this form of communication. Which was made possible by using the library opcua-asyncio.
...
\begin{center}
	\includegraphics[width=0.8\linewidth]{images/design_of_project_concept.png}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Details}{name=details,column=1,span=1,row=0, below=problem}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center}
	\includegraphics[width=0.35\linewidth]{images/sequence_diagram.jpg}
\end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The talking machines team was able to implement the following use cases.
Simple state requests:
\begin{center}
	\includegraphics[width=0.35\linewidth]{images/use_case_1.jpg}
\end{center}
Proactive communication, optional continuations and processing contextual information:
\begin{center}
	\includegraphics[width=0.35\linewidth]{images/use_case_2.jpg}
\end{center}
Proactive communication and processing contextual information:
\begin{center}
	\includegraphics[width=0.35\linewidth]{images/use_case_3.jpg}
\end{center}
}
\headerbox{Outlook}{name=outlook,column=1,span=1,below=results}{
  ...
  Implementation of this would need an adaption of the current implementation to the specific machine. 
